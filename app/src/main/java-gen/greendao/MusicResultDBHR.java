...
/**
 * Entity mapped to table MUSIC_RESULT_DBHR.
 */
public class MusicResultDBHR implements java.io.Serializable {
    ...
    public MusicResultDBHR() {
    }

    public MusicResultDBHR(Long id) {
        this.id = id;
    }
