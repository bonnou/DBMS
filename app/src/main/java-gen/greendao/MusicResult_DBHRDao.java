...
import greendao.MusicResult_DBHR;

// THIS CODE IS GENERATED BY greenDAO, DO NOT EDIT.
/** 
 * DAO for table MUSIC_RESULT__DBHR.
*/
public class MusicResult_DBHRDao extends AbstractDao<MusicResult_DBHR, Long> {

    public static final String TABLENAME = "MUSIC_RESULT__DBHR";

    /**
     * Properties of entity MusicResult_DBHR.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property ScoreRank = new Property(4, Double.class, "scoreRank", false, "SCORE_RANK");
    ...
    public MusicResult_DBHRDao(DaoConfig config) {
        super(config);
    }
    
    public MusicResult_DBHRDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MUSIC_RESULT__DBHR' (" + //
                "'_id' INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                "'CLEAR_LAMP' TEXT," + // 1: clearLamp
                "'EX_SCORE' INTEGER," + // 2: exScore
                "'BP' INTEGER," + // 3: bp
                "'SCORE_RANK' REAL," + // 4: scoreRank
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MUSIC_RESULT__DBHR'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MusicResult_DBHR entity) {
        stmt.clearBindings();
        ...
        Double scoreRank = entity.getScoreRank();
        if (scoreRank != null) {
            stmt.bindDouble(5, scoreRank);
        }
    ...
    /** @inheritdoc */
    @Override
    public MusicResult_DBHR readEntity(Cursor cursor, int offset) {
        MusicResult_DBHR entity = new MusicResult_DBHR( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4), // scoreRank
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MusicResult_DBHR entity, int offset) {
        ...
        entity.setScoreRank(cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4));
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MusicResult_DBHR entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MusicResult_DBHR entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
