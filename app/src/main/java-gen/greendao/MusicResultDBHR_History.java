...
/**
 * Entity mapped to table MUSIC_RESULT_DBHR__HISTORY.
 */
public class MusicResultDBHR_History implements java.io.Serializable {

    private Long id;
    private String name;
    private String nha;
    private java.util.Date insDate;
    private Boolean playedFlg;
    ...
    public Boolean getPlayedFlg() {
        return playedFlg;
    }

    public void setPlayedFlg(Boolean playedFlg) {
        this.playedFlg = playedFlg;
    }
    ...
    public java.util.Date getLastPlayDate() {
        return lastPlayDate;
    }

    public void setLastPlayDate(java.util.Date lastPlayDate) {
        this.lastPlayDate = lastPlayDate;
    }
